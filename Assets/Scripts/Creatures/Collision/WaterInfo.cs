...
namespace Creatures.Collision {
    public class WaterInfo: MonoBehaviour {
        ...
        public void SetColliders(BaseCreature creature) {
            this.SetColliders(creature.bodyPart.bodyLimb.creatureCollider.collider, creature.compiledTraits.height);
        }
        public void SetColliders(Collider collider, float extraHeight) {
